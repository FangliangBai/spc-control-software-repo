...
function [xp, tp] = tvqc_logbarrier(imageH,imageV, x0, A, At, b, epsilon, lbtol, mu, cgtol, cgmaxiter)  
...
for ii = 1:lbiter
  ...
  [xp, tp, ntiter] = tvqc_newton(x, t, A, At, b, epsilon, tau, newtontol, newtonmaxiter, cgtol, cgmaxiter,imageH,imageV);
