...
function xp = tveq_logbarrier(x0, A, At, b, lbtol, mu, slqtol, slqmaxiter,imageH,imageV)  
...
for ii = 1:lbiter
  ...
  [xp, tp, ntiter] = tveq_newton(x, t, A, At, b, tau, newtontol, newtonmaxiter, slqtol, slqmaxiter,imageH,imageV);
