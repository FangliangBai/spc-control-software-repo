function varargout = single_pixel_camera3(varargin)
%Version 1.0
%Author: Pedro Dreyer University of Kent 22/11/14

%SINGLE_PIXEL_CAMERA3 M-file for single_pixel_camera3.fig
%      SINGLE_PIXEL_CAMERA3, by itself, creates a new SINGLE_PIXEL_CAMERA3 or raises the existing
%      singleton*.
%
%      H = SINGLE_PIXEL_CAMERA3 returns the handle to a new SINGLE_PIXEL_CAMERA3 or the handle to
%      the existing singleton*.
%
%      SINGLE_PIXEL_CAMERA3('Property','Value',...) creates a new SINGLE_PIXEL_CAMERA3 using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to single_pixel_camera3_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      SINGLE_PIXEL_CAMERA3('CALLBACK') and SINGLE_PIXEL_CAMERA3('CALLBACK',hObject,...) call the
%      local function named CALLBACK in SINGLE_PIXEL_CAMERA3.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help single_pixel_camera3

% Last Modified by GUIDE v2.5 29-Jul-2015 17:06:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @single_pixel_camera3_OpeningFcn, ...
    'gui_OutputFcn',  @single_pixel_camera3_OutputFcn, ...
    'gui_LayoutFcn',  [], ...
    'gui_Callback',   []);
...
% --- Executes just before single_pixel_camera3 is made visible.
function single_pixel_camera3_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for single_pixel_camera3
...
% UIWAIT makes single_pixel_camera3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = single_pixel_camera3_OutputFcn(hObject, eventdata, handles)
...
reconstruction = CS_reconstruction(data,basis,imageH,imageV,recoveryMethod,...
    colorMode,epsilon,removeDC,sparsity);
...
set(handles.push_flat_field,'Visible','on')
